drop function if exists create_student(text, text, text, text, rate_type, integer, boolean, integer, boolean, text, text, boolean, text);
...
alter table clients drop column if exists needs_goals;
